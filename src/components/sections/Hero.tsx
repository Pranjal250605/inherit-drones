...
/* ============================================================
   Hero — "Command Deck" banner
   An angled, full-bleed dark→orange panel carrying the four
   headline metrics as glass cards, framed by wireframe drones
   and instrumentation HUD chrome. The card data is the shared
   stats dictionary (count-up + progress bars wired via the
   global GSAP attribute vocabulary).
============================================================ */
...
export function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-hidden bg-bg pt-16 lg:pt-20">
      <div className="relative">
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute left-[28%] top-[24%] hidden font-mono text-[10px] font-semibold uppercase tracking-[0.34em] text-orange-100/55 lg:block">
            <div>/// ADVANCED</div>
            <div className="mt-1 pl-4">» AERIAL SYSTEM</div>
          </div>

          {/* bottom-right caption */}
          <div className="absolute bottom-[16%] right-[4%] hidden text-right font-mono text-[10px] font-semibold uppercase tracking-[0.34em] text-white/35 lg:block">
            <div>PRECISION</div>
            <div>PERFORMANCE ///</div>
          </div>

          {/* crosshair marks */}
          {["left-[6%] top-[34%]", "left-[40%] top-[20%]", "right-[24%] top-[28%]", "left-[30%] bottom-[16%]", "right-[14%] bottom-[34%]"].map((pos) => (
        ...
        {/* ===== Content ===== */}
        <div className="relative mx-auto max-w-[87.5rem] px-6 py-16 sm:py-20 lg:px-12 lg:py-28">
          <div
