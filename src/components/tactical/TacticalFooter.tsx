...
export function TacticalFooter() {
  ...
  return (
    <footer className="relative border-t border-white/10 px-6 pt-20 pb-10 lg:px-16">
      {/* link grid */}
      <div className="mx-auto grid w-full max-w-[1240px] grid-cols-2 gap-8 md:grid-cols-4">
      ...
      <div className="mx-auto mt-16 flex w-full max-w-[1240px] flex-wrap items-center gap-x-6 gap-y-2 border-t border-white/10 pt-6">
